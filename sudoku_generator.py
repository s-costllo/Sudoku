...
class Board:
    ...
    def select(self, row, col):
        # top
        pygame.draw.line(self.screen, (51, 77, 143), (398 + row * 67, col * 67), (398 + row * 67 + 67, col * 67), 4)
        # left
        pygame.draw.line(self.screen, (51, 77, 143), (398 + row * 67, col * 67), (398 + row * 67, col * 67 + 67), 4)
        # bottom
        pygame.draw.line(self.screen, (51, 77, 143), (398 + row * 67, col * 67 + 67),
                         (398 + row * 67 + 67, col * 67 + 67), 4)
        # right
        pygame.draw.line(self.screen, (51, 77, 143), (397 + row * 67 + 67, col * 67),
                         (397 + row * 67 + 67, col * 67 + 67), 4)
